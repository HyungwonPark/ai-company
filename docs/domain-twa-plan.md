...
> 이 문서는 2026-09-14의 준비 기록이다. 사용자 후속 요청으로 서명 APK 0.1.0을 실제 빌드·게시하고 공개 인증서 경로를 승인 후 적용한 2026-09-15 최신 상태는 [APK 전달·검증 기록](android-apk-validation-2026-09-15.md)에 있다. 아래의 당시 미구현·미게시 상태를 현재 완료 여부로 읽지 않는다.
