...
- 실제 Claude Haiku 번역, [Opus 5·xhigh·Ultracode와 작은 Workflow](claude-runtime-settings-2026-09-16.md), 별도 큐의 [격리 개발 이관·세션 재개](claude-dispatcher-2026-09-16.md)를 확인했다. 새 증거 정책과 실행기는 운영 미활성이므로 공개 화면에 개발 자동 대체 가능으로 표시하지 않는다.
