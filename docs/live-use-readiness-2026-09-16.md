...
| Claude | 새 정책의 격리 개발 이관·같은 세션 재개 확인. [같은 후보의 새 읽기 전용 로컬 검수](claude-review-2026-09-16.md)도 PASS, 과거 비용 중단은 보존. 운영 정책은 미활성이고 앱 전체 검수와는 구분. 내장 Bash 오류·전역 격리 제한 유지 |
