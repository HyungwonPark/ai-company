...
최신 실제 운영은 [승인된 `5594744` 적용 결과](production-activation-2026-09-16.md)다. 웹·두 worker·Claude 개발 대체 후보를 한 번 교체했고, 제한된 번역 복구는 4건 반영·2건 오탐 차단으로 종료했다. 아래 이전 적용 대기 기록은 각 시점의 기록으로 보존한다.
...
| 항목 | 완료·차단과 다음 행동 |
|---|---|
| 공개 화면 | 승인한 `5594744` 웹 적용 완료. `c2b3fec` 별도 교체 없음. PR #12 후속 UX 후보는 별도 검수·미적용 |
