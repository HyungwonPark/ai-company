...
후속 [Claude 실제 적용 설정·동적 Workflow](claude-runtime-settings-2026-09-16.md)에서 Opus 5·xhigh·Ultracode와 작은 읽기 전용 병렬 실행을 확인했다. 아래 과거의 effort 미확인 기록은 보존하며, 운영 증거 계약·쓰기 격리·실제 이관 연결은 계속 미완료다.
...
| Claude | 실제 Opus 5·xhigh·Ultracode·두 Workflow 자식 실행 확인. 내장 Bash 오류는 유지하되 [별도 파일 도구의 격리·실제 읽기/쓰기](claude-file-tools-2026-09-16.md)는 검증 완료. 운영 증거 정책·이관·재개 연결이 남아 개발 대체자는 아직 부적격 |
