...
다음 구축 단계인 [프로젝트별 실행 명세와 PM 제안·계획 확정](project-execution-specs-2026-09-16.md)은 별도 미적용 후보로 진행한다. 기존 공개 적용과 실행 범위는 보존하며, APK에서 마스터가 직접 조작하는 검증과 서명키의 외부 보관·복원 확인은 계속 미완료다. [저장 번역 재검사](translation-saved-recheck-2026-09-16.md)도 복사본 검증과 운영 적용을 구분한다.
