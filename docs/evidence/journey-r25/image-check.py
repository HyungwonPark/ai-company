...
with tempfile.TemporaryDirectory() as directory:
 ...
 try:
  assets={}
  for endpoint,name in [('/','web/index.html'),('/app.js','web/app.js'),('/report-ui.js','web/report-ui.js'),('/sw.js','web/sw.js'),('/workspace-graph-ui.js','web/workspace-graph-ui.js')]:
  ...
  assert b'ai-company-shell-v10' in request('/sw.js')[2]
