...
export function createExecutionUI({esc,stamp}) {
  ...
  function render(overview,{entries=[],specs=[],error='',loaded=false,connected=true,intent=null}={}) {
