...
const CACHE='ai-company-shell-v3';
const SHELL=['/','/index.html','/styles.css','/theme.js','/fonts/fonts.css','/fonts/ibmplexsans-400.woff2','/fonts/ibmplexsans-500.woff2','/fonts/ibmplexsans-600.woff2','/app.js','/collaboration-ui.js','/documents-ui.js','/icon.svg','/manifest.webmanifest'];
